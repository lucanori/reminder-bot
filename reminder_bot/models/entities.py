...
class UserEntity(Base):
    ...
    reminders: Mapped[list["ReminderEntity"]] = relationship(
        "ReminderEntity", back_populates="user"
    )
...
class ReminderEntity(Base):
    ...
    notification_history: Mapped[list["NotificationHistoryEntity"]] = relationship(
        "NotificationHistoryEntity", back_populates="reminder"
    )
...
class NotificationHistoryEntity(Base):
    ...
    reminder: Mapped["ReminderEntity"] = relationship(
        "ReminderEntity", back_populates="notification_history"
    )
